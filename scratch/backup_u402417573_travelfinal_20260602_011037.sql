-- Travel Without Limits Database Backup
-- Generated on 2026-06-02 01:10:37
...
('menu-destinations', 'DESTINATIONS', 'الوجهات', 'destinations', 'MEGA', 'LIST', NULL, '1', '1', '2026-05-27 04:27:01', '2026-05-27 06:23:01'),
...
INSERT INTO `site_settings` (`id`, `siteName_en`, `siteName_ar`, `logoUrl`, `logoDarkUrl`, `heroBackgroundUrl_en`, `heroBackgroundUrl_ar`, `metaTitle_en`, `metaTitle_ar`, `metaDescription_en`, `metaDescription_ar`, `ogImage`, `faviconUrl`, `primaryColor`, `secondaryColor`, `accentColor`, `backgroundColor`, `textColor`, `updated_at`, `themeMode`, `fontFamily`, `fontFamilyBody`, `fontFamilyAr`, `fontFamilyArBody`, `fontSize`, `headingWeight`, `bodyWeight`, `letterSpacing`, `lineHeight`, `surfaceColor`, `borderColor`) VALUES 
('1', 'Young Over 60', NULL, NULL, NULL, '/images/hero-bg.png', '/images/hero-bg.png', '', NULL, '', NULL, NULL, '/favicon.ico', '#2d5a88', '#1e3c5a', '#eaeaea', '#ffffff', '#111111', '2026-05-29 21:31:31', 'light', 'Outfit', 'Inter', 'Almarai', 'Almarai', '16px', '700', '400', 'normal', '1.8', '#ffffff', 'rgba(0,0,0,0.05)');
