<?php
// scratch/migrate_hero_video.php
// Safe, idempotent migration to add hero modes & video backgrounds to site_settings table.
...
try {
    ...
    $sqlDump = "-- Travel Without Limits Database Backup (Hero Video Migration)\n";
