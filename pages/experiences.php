...
<main class="container">
    <!-- Breadcrumbs -->
    <?php renderBreadcrumbs(['Experiences' => '']); ?>
    ...
    <section class="content-list-section">
        <div class="mb-16 text-center max-w-3xl mx-auto" data-scroll-reveal>
            ...
            <h1 class="serif-title" style="margin-top: 1rem;">Experiences</h1>
            <p style="color: #666666; font-size: 1.1rem; font-weight: 300; margin-top: 1rem;">
                Explore stories categorized by activity style. Discover accessible cruising itineraries, theme park guides, culinary journeys, and relaxing outdoor adventures.
            </p>
        </div>
        ...
        <div class="needs-grid" style="margin-top: 4rem;">
            <?php foreach ($expList as $exp): 
                ...
                ?>
                <a href="<?php echo BASE_URL; ?>/category/<?php echo $exp['slug']; ?>" class="needs-card" data-scroll-reveal aria-label="Explore <?php echo e($exp['name']); ?>">
                    <img src="<?php echo e(!empty($exp['image']) ? $exp['image'] : '/images/hero-bg.png'); ?>" alt="<?php echo e($exp['name']); ?>" loading="lazy" />
                    <div class="needs-card-overlay">
                        <div class="needs-card-line"></div>
                        <h2 class="needs-card-title"><?php echo e($exp['name']); ?></h2>
