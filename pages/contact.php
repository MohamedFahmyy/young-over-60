...
<main class="container">
    ...
    <div class="contact-grid animate-in fade-in" data-scroll-reveal>
        ...
        <div class="contact-info-panel">
            ...
            <div style="font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.2em; opacity: 0.5; margin-top: 4rem;">
        ...
        <div class="contact-form-panel">
            ...
            <form id="contactForm" action="<?php echo BASE_URL; ?>/api/contact" method="POST" class="newsletter-form">
                ...
                <div class="form-group">
                    <label for="form-name" style="font-size: 0.65rem; text-transform: uppercase; font-weight: 900; letter-spacing: 0.15em; color: #999;">Full Name</label>
                    <input type="text" id="form-name" name="name" class="form-input" placeholder="e.g. Jane Doe" required />
                </div>

                <div class="form-group">
                    <label for="form-email" style="font-size: 0.65rem; text-transform: uppercase; font-weight: 900; letter-spacing: 0.15em; color: #999;">Email Address</label>
                    <input type="email" id="form-email" name="email" class="form-input" placeholder="e.g. jane@example.com" required />
                </div>

                <div class="form-group">
                    <label for="form-phone" style="font-size: 0.65rem; text-transform: uppercase; font-weight: 900; letter-spacing: 0.15em; color: #999;">Phone Number</label>
                    <input type="text" id="form-phone" name="phone" class="form-input" placeholder="e.g. +61 400 000 000" required />
                </div>

                <div class="form-group">
                    <label for="form-message" style="font-size: 0.65rem; text-transform: uppercase; font-weight: 900; letter-spacing: 0.15em; color: #999;">Your Message</label>
                ...
                <button type="submit" class="btn-primary" style="margin-top: 1rem; border-radius: 8px;">
                    Send Message
                </button>
            </form>
        </div>
