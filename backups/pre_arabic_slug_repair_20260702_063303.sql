-- Database Backup before Arabic Slug Repair
-- Generated on 2026-07-02 06:33:03
...
INSERT INTO `women_stories` (`id`, `title_en`, `title_nl`, `title_ar`, `slug_en`, `slug_nl`, `slug_ar`, `excerpt_en`, `excerpt_nl`, `excerpt_ar`, `content_en`, `content_nl`, `content_ar`, `cover_image`, `alt_text_en`, `alt_text_nl`, `alt_text_ar`, `category_en`, `category_nl`, `category_ar`, `author_en`, `author_nl`, `author_ar`, `read_time`, `created_at`) VALUES ('test-repair-story-id', 'Test Repair Story EN', '', 'قصة تجربة الإصلاح المكسورة', 'test-repair-story-en', '', 'n-a', '', '', '', 'Content EN', '', 'Content AR', '', '', '', '', 'General', '', 'عام', 'Guest', '', '', '5 min read', '2026-07-01 23:03:17');
