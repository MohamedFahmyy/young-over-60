                ...
                <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                    ...
                    <div class="admin-card-box" style="padding: 1.75rem;">
                        ...
                        <div id="tab-content-en" class="admin-tab-content active">
                            <textarea id="content_en" name="content_en" rows="18" class="admin-form-textarea" placeholder="Write your page content in HTML or plain text..."><?php echo htmlspecialchars($p['content_en'] ?? ''); ?></textarea>
                        </div>
                        <div id="tab-content-ar" class="admin-tab-content" style="direction:rtl;">
                            <textarea id="content_ar" name="content_ar" rows="18" class="admin-form-textarea" placeholder="اكتب محتوى الصفحة..." dir="rtl"><?php echo htmlspecialchars($p['content_ar'] ?? ''); ?></textarea>
                        </div>
                    </div>
